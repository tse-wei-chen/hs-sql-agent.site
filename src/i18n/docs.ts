...
const docsUi: Record<string, DocsUiStrings> = {
  ...
  fr: {
    ...
    centerLabel: "Centre de documentation",
    navigation: "Documentation",
    closeNavigation: "Fermer la navigation de la documentation",
    copy: "Copier",
    copied: "Copié",
    code: "Code",
    paginationLabel: "Pagination de la documentation",
    previous: "Précédent",
    next: "Suivant",
    ...
    sections: {
      ...
      reference: "Référence",
      security: "Sécurité",
      "sql-compiler": "Compilateur SQL",
    },
  },
  de: {
    kicker: "Dokumentation",
    centerLabel: "Dokumentationszentrum",
    navigation: "Dokumentation",
    closeNavigation: "Dokumentationsnavigation schließen",
    copy: "Kopieren",
    copied: "Kopiert",
    code: "Code",
    paginationLabel: "Dokumentationsnavigation",
    previous: "Zurück",
    next: "Weiter",
