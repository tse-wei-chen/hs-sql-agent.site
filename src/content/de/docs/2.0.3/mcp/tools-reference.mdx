...
description: Built-in-MCP-Tool-Verträge für hs-sql-agent einschließlich atomarem Multi-Statement-DML.
sidebar:
  group: MCP
  order: 35
---

Die Built-in-MCP-Oberfläche bleibt bewusst klein. hs-sql-agent enthält weiterhin genau fünf Tool-Namen, die über den MCP-Key-Scope verwaltet werden.
