...
description: Datenbankverbindungen konfigurieren und betreiben, die über hs-sql-agent bereitgestellt werden.
sidebar:
...
hs-sql-agent unterstützt über die gemeinsame SQL-Provider-Runtime folgende Providerkennungen:
...
Das Datenbank-Anfragemodell enthält folgende Felder:
...
Die Admin API verwendet explizite Berechtigungen:
