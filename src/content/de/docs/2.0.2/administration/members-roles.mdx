...
description: Admin-Benutzer, Sitzungen, Rollenzuweisungen und den Rollenlebenszyklus in hs-sql-agent 2.0.2 verwalten.
sidebar:
...
Der Controller in 2.0.2 verhindert ausdrücklich, dass Administratoren über diese Verwaltungsendpunkte ihre eigenen Rollen ändern, ihr eigenes Konto deaktivieren oder ihren eigenen Mitgliedsdatensatz löschen.
</Callout>
