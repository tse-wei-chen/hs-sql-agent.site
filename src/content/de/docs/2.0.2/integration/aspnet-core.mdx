...
`HsSqlAgent.Server` ist ein einbettbares ASP.NET-Core-Klassenbibliothekspaket. Neue Integrationen beginnen mit einem Core ohne Options und wählen danach ausdrücklich die Capabilities, die der Host benötigt.
...
Diese Mounts sind bewusst fest. Beliebige Relokation wird nicht als unterstützt beworben, solange Routing, Frontend-Basispfade/Assets, Callbacks und Sicherheitsgrenzen nicht gemeinsam verschoben werden können.
