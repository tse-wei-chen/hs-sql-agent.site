...
Alle Sprachversionen teilen bewusst dieselbe Struktur aus Version, Abschnitt und Slug und unterscheiden sich nur durch das Locale-Präfix. Die vollständige Dokumentationsbasis wird über die konfigurierte Versionsvererbung aufgelöst.
