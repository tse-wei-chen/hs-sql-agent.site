...
Der Server unterstützt lokale Authentifizierung sowie optionale Einstellungen für OIDC/SSO und TOTP-MFA. Zu den OIDC-Einstellungen gehören Authority, Client-Anmeldedaten, Claim-Zuordnungen, Scopes, Rollenzuordnungen, Anforderungen an verifizierte E-Mail-Adressen und automatische Bereitstellung.
...
Veröffentlichen Sie Sicherheitslücken nicht in einem öffentlichen Issue. Verwenden Sie im Repository den Ablauf **Report a Vulnerability** von GitHub Security Advisory, damit das Problem im Rahmen einer verantwortungsvollen Offenlegung untersucht und behoben werden kann.
