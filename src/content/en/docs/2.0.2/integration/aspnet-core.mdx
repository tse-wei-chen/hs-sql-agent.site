...
<CardGrid columns={2}>
  <DocCard title="Configuration Reference" icon="CFG" href="/docs/operations/configuration" description="Review standalone environment settings and the capability-specific options used by embedded .NET hosts." />
  <DocCard title="Deployment" icon="OPS" href="/docs/operations/deployment" description="Apply production hosting, secrets, persistence, reverse-proxy, and operational guidance." />
</CardGrid>
