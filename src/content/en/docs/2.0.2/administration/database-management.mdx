...
description: Configure and operate database connections exposed through hs-sql-agent 2.0.2.
sidebar:
...
2.0.2 supports these provider identifiers through the shared SQL provider runtime:
...
The 2.0.2 database request model contains these fields:
...
The 2.0.2 Admin API applies explicit permissions to Database Management operations:
