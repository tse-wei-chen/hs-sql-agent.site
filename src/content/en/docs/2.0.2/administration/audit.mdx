...
Audit records answer **who did what, against which governed resource, with what result**. Metrics and traces answer runtime health and performance questions. Use [Operability](/docs/administration/operability) and [Observability](/docs/operations/observability) for those surfaces.
