---
title: Audit
description: Query, summarize, export, and retain hs-sql-agent audit records from the Admin control plane.
sidebar:
...
The export endpoint accepts `format=csv` or `format=json`. hs-sql-agent rejects export sets over 100,000 rows instead of attempting an unbounded download.
