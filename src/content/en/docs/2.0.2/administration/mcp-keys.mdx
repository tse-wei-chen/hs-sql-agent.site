---
title: MCP Keys
description: Issue, scope, rotate, clone, and revoke MCP credentials in hs-sql-agent 2.0.2.
sidebar:
...
## Formal 2.0.2 built-in tool surface
...
<Steps>
  ...
  <Step title="Bind a database" description="DbManagementId is required by the 2.0.2 issuance validator." />
