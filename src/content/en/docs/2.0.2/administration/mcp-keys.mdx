---
title: MCP Keys
description: Issue, scope, rotate, clone, and revoke MCP credentials in hs-sql-agent.
sidebar:
...
<Steps>
  ...
  <Step title="Bind a database" description="DbManagementId is required by the hs-sql-agent issuance validator." />
