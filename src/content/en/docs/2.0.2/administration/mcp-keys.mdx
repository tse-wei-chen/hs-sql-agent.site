...
Published Custom Tools for the same database can also be selected by name. See [Custom Tools](/docs/administration/custom-tools).
...
Read [MCP client onboarding](/docs/mcp/client-onboarding) before granting DML to a new client.
