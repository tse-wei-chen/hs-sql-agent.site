...
Both translations intentionally share the same version/section/slug and are separated by locale-prefixed routes. The complete documentation baseline is resolved through the configured version lineage.
