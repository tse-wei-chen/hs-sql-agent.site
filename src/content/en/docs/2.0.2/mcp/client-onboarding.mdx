...
<CardGrid columns={2}>
  <DocCard title="MCP Tools Reference" icon="REF" href="/docs/mcp/tools-reference" description="Review the built-in discovery, query, and DML tool contracts." />
  <DocCard title="Safe DML" icon="DML" href="/docs/sql-compiler/safe-dml" description="Understand preview, approval binding, row-set revalidation, and commit." />
</CardGrid>
