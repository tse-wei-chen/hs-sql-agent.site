...
Install `HsSqlAgent.Server`, call `AddHsSqlAgentCore()`, and explicitly add the runtime, Admin Store/API, MCP, identity, telemetry, and approval capabilities that your application needs. See [ASP.NET Core integration](/docs/integration/aspnet-core).
