---
title: Members & Roles
description: Manage Admin users, sessions, role assignment, and role lifecycle in hs-sql-agent 2.0.1.
sidebar:
...
The 2.0.1 controller explicitly prevents an administrator from changing their own roles, disabling their own account, or deleting their own member record through these management endpoints.
</Callout>
