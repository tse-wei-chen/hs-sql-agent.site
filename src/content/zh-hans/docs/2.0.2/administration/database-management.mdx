---
title: 数据库管理
description: 配置和运维通过 hs-sql-agent 暴露的数据库连接。
sidebar:
  group: 管理
  order: 72
---
...
hs-sql-agent 通过统一 SQL provider runtime 支持以下 provider 标识：
...
hs-sql-agent Admin API 对 Database Management 操作执行明确权限检查：
