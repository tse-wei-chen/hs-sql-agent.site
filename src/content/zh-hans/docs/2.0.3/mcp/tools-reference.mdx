---
title: MCP Tools 参考
description: hs-sql-agent 的 built-in MCP Tool 契约，包括原子 multi-statement DML。
sidebar:
  group: MCP
  order: 35
---

Built-in MCP Surface 刻意保持精简。hs-sql-agent 仍只有五个由 MCP Key Scope 管理的 built-in Tool 名称。
