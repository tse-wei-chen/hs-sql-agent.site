...
description: hs-sql-agent の built-in MCP Tool 契約。原子的な multi-statement DML を含みます。
sidebar:
  group: MCP
  order: 35
---

Built-in MCP Surface は意図的に小さく保たれています。hs-sql-agent でも MCP Key Scope で管理される built-in Tool 名は 5 つだけです。
