...
description: Contrats des built-in MCP Tools de hs-sql-agent, avec DML multi-statement atomique.
sidebar:
  group: MCP
  order: 35
---

La surface MCP built-in reste volontairement petite. hs-sql-agent conserve exactement cinq noms de Tools gérés par le scope des clés MCP.
