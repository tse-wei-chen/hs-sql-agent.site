---
title: Clés MCP
description: Émettre, restreindre, renouveler, dupliquer et révoquer les identifiants MCP dans hs-sql-agent.
sidebar:
...
## Surface officielle des outils intégrés hs-sql-agent
...
<Steps>
  ...
  <Step title="Lier une base" description="DbManagementId est requis par le validateur d’émission hs-sql-agent." />
