---
title: Clés MCP
description: Émettre, restreindre, renouveler, dupliquer et révoquer les identifiants MCP dans hs-sql-agent 2.0.2.
sidebar:
...
<Steps>
  ...
  <Step title="Lier une base" description="DbManagementId est requis par le validateur d’émission 2.0.2." />
