...
L’endpoint d’export accepte `format=csv` ou `format=json`. hs-sql-agent refuse les ensembles dépassant 100 000 lignes au lieu de tenter un téléchargement sans borne.
