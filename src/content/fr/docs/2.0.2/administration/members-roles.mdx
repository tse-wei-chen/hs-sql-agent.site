...
description: Gérer les utilisateurs Admin, les sessions, l’attribution de rôles et le cycle de vie des rôles dans hs-sql-agent 2.0.2.
sidebar:
...
Le contrôleur 2.0.2 empêche explicitement un administrateur de modifier ses propres rôles, de désactiver son propre compte ou de supprimer son propre enregistrement via ces endpoints de gestion.
</Callout>
