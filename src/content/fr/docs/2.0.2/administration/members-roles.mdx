...
description: Gérer les utilisateurs Admin, les sessions, l’attribution de rôles et le cycle de vie des rôles dans hs-sql-agent.
sidebar:
...
La liste peut être filtrée par recherche, statut actif et rôle, et elle est paginée. La vue indique l’état du compte, les dates de création/dernière connexion, le nombre de sessions actives ainsi que les identifiants/noms des rôles courants.
...
Le contrôleur empêche explicitement un administrateur de modifier ses propres rôles, de désactiver son propre compte ou de supprimer son propre enregistrement via ces endpoints de gestion.
</Callout>
