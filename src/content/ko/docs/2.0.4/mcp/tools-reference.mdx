---
title: MCP 도구 참조
description: hs-sql-agent의 내장 MCP 도구 계약입니다. 서버가 공개 범위를 정확히 5개 도구로 강제합니다.
sidebar:
  group: MCP
  order: 35
---
...
`update_semantic_layer`는 hs-sql-agent의 내장 MCP 도구가 아닙니다. Semantic Layer는 제어 영역 설정이며 Admin UI 또는 권한으로 보호되는 Admin API에서 편집합니다.
